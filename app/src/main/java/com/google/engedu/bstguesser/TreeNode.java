...
public class TreeNode {
    ...
    public void insert(int valueToInsert) {
        ...
        {
            if(this.left==null){this.left = new TreeNode(valueToInsert);}
            else this.left.insert(valueToInsert);
        }
        else
    {
        if(this.right==null){this.right = new TreeNode(valueToInsert);}
        else this.right.insert(valueToInsert);}
